...
var EntityGenerator = module.exports = function EntityGenerator(args, options, config) {
  ...
  this.on('end', function () {
    console.log('Creating ' + this.name + ' table...');
    return this.spawnCommand('lua', ['db/create_' + this.name + '_table.lua']);
  });
...
EntityGenerator.prototype.files = function files() {
  ...
  this.template('../../app/templates/_app.lua', 'app.lua');
  this.template('db/_create_entity_table.lua', dbDir + 'create_' + this.name + '_table.lua');
